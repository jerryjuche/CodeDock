...
class ChatManager {
    ...
    open() {
        ...
        this.panel = vscode.window.createWebviewPanel('codedockChat', 'CodeDock Chat', vscode.ViewColumn.Beside, {
            enableScripts: true,
    ...
    sendMessage(content) {
        ...
        const payload = (0, protocol_1.encodeChatPayload)(message);
    ...
    // --- Inbound ---
    handleIncoming(data) {
        if (data[0] !== protocol_1.MessageType.CHAT) {
            return;
        }
        const message = (0, protocol_1.decodeChatPayload)(data);
