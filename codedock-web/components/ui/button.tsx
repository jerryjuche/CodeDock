...
export const buttonBaseClasses =
  "group relative inline-flex items-center justify-center overflow-hidden rounded-[12px] font-medium transition-all duration-200 ease-out disabled:cursor-not-allowed disabled:opacity-50 transform hover:-translate-y-[1px] active:translate-y-0";
...
export const variantClasses: Record<ButtonVariant, string> = {
  ...
  ghost: "bg-transparent text-[rgb(234,244,255)] hover:bg-white/6",
  destructive:
  ...
  (
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "group relative inline-flex items-center justify-center overflow-hidden rounded-[12px] font-medium transition-all duration-200 ease-out disabled:cursor-not-allowed disabled:opacity-50",
